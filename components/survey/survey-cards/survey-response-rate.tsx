...
type SurveysResponseRateCardProps = {
  value: number | undefined;
};

export const SurveysResponseRateCard = ({ value }: SurveysResponseRateCardProps) => {
  return (
    <div className="school_card relative w-full max-sm:min-h-[180px] flex flex-col justify-between space-y-14 h-[154px]">
      <div className="space-y-1">
        <p className="text-grey-500 text-base font-medium">Survey Response Rate</p>
